    ...
    <div class="row">
        <div class="col-md-7 text-center" style="min-height: 100vh;">
            <div class="row">
                ...
                <div class="col-md-7 ">
                    <h1 style="margin: 10vh 0; font-size: 3rem; text-transform: capitalize;"> Find your next <br>role with Career City!
                    </h1>
        ...
        <div class="col-md-5" style="background: #4B286D; width: 100%; height: 100%; color: white; min-height: 100vh; padding: 4rem">
            <div class="text-center">
                ...
                <h3 style="text-transform: capitalize;">Take your career to<br>the next level</h3>
            </div>
            <hr class="text-white">
            <a class="btn btn-success form-control" href="#">Start Your Career Path!</a>
        </div>
    </div>
</section>
<!------- LIBRARIES --------->
